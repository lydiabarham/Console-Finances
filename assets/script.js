...
// Create monthly change array

var monthlyChangeArray = [];
var rows = financesChange.length - 1;
var columns = 2;

for (var i = 1; i < rows; i++) {
    monthlyChangeArray[i] = [financesChange[i - 1][0] + " to " + financesChange[i][0]];
    var difference = financesChange[i][1] - financesChange[i - 1][1];
...
for (var i = 1; i < monthlyChangeArray.length; i++) {
    changesTotal += monthlyChangeArray[i][1];
}

// Find the average
var averageChange = changesTotal / (monthlyChangeArray.length - 1);
